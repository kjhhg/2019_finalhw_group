    ...
    <table id="cart" class="table-Danger table-hover table-sm no-border  grey-text"> 
      <thead>
        <tr>
          ...
          <th style="width:10%; text-align:center;">剩餘數量</th>
      ...
      <tfoot>
        ...
        <tr>
          <td>
            <button class="btn lg-color btn-cart" @click="saveShoppingCartLocal">
          ...
          <td class="px-0">
            <button class="btn lg-color btn-cart" @click="checkout">
